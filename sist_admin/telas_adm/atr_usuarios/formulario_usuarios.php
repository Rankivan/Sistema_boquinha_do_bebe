         ...
         <div>
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="date" class="form-control" placeholder="insira a quantidade de itens" required="" name="data_nascimento">
                    </div>
                  ...
                  <div class="form-row">
                      ...
                      <div class="form-group col-md-4">
                            <label >Tipo de usuário</label>
                             <select  class="form-control" required="" id="tipo_usu_select"  onchange="tipo_usuario_select_js()" name="tipo_usuario" >
