...
<div class="form-row"><!--DIV-->
  ...
  <div class="form-group col-md-6">
    ...
    <input type="text" name="nome_evento" class="form-control" placeholder="Insira o nome do evento a ser criado" >
  </div>
...
<div class="form-row"><!--DIV-->
  ...
  <div class="form-group col-md-3">
    ...
    <input  type="date" class="form-control" placeholder="coloque o dia em que irá acontecer o evento" name="data_inicio_evento">
  </div>

  <div class="form-group col-md-3">
    <label >Horário de inicio </label>
    <input type="time"  class="form-control" placeholder="" name="horario_inicio_evento">
  </div>
...
<div class="form-row"><!--DIV-->
  ...
  <div class="form-group col-md-3">
    ...
    <input  type="date" class="form-control" placeholder="coloque o dia em que irá acontecer o evento" name="data_final_evento">
  </div>

  <div class="form-group col-md-3">
    <label > até o horário final </label>
    <input type="time"  class="form-control" placeholder="" name="horario_final_evento">
  </div>
...
<div class="form-row">
             <div class="form-group col-md-6"><!--MODIFICAR-->
                      ...
                      <select name="nome_posto_pac" type="text" name="local_evento" class="form-control"> 
