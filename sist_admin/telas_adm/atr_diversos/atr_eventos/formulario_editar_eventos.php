...
<div class="form-row"><!--DIV-->
  ...
  <div class="form-group col-md-6">
    ...
    <input type="text" value="<?php echo($nome_evento) ?>" id="nome_evento_edit" name="nome_evento_edit" class="form-control" placeholder="Insira o nome do evento a ser criado" disabled >
  </div>
...
<div class="form-row"><!--DIV-->
  ...
  <div class="form-group col-md-3">
    ...
    <input value="<?php echo($data_inicio_evento) ?>" id="data_inicio_evento_edit" type="date" class="form-control" placeholder="coloque o dia em que irá acontecer o evento" name="data_inicio_evento_edit" disabled>
  </div>

  <div class="form-group col-md-3">
    <label >Horário de inicio </label>
    <input  id="horario_inicio_evento_edit" value="<?php echo($horario_inicio_evento) ?>" type="time"  class="form-control" placeholder="" name="horario_inicio_evento_edit" disabled>
  </div>
...
<div class="form-row"><!--DIV-->
  ...
  <div class="form-group col-md-3">
    ...
    <input value="<?php echo($data_final_evento) ?>" type="date" class="form-control" placeholder="coloque o dia em que irá acontecer o evento" name="data_final_evento_edit" id="data_final_evento_edit" disabled>
  </div>

  <div class="form-group col-md-3">
    <label > até o horário final </label>
    <input id="horario_final_evento_edit" value="<?php echo($horario_final_evento) ?>" type="time"  class="form-control" placeholder="" name="horario_final_evento_edit" disabled>
  </div>
...
<div class="form-row">
             <div class="form-group col-md-6"><!--MODIFICAR-->
                      ...
                      <select id="nome_posto_evento_edit" name="nome_posto_evento_edit" type="text" name="local_evento" class="form-control" disabled> 
