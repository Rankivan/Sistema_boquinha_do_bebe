...
<form method="post" action="../../back_end/inserir_bd/eventos/excluir_eventos.php">
  <div class="modal fade" id="modal_excluir_eventos" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel">EXCLUIR N° <y style='color: #9e0000'><?php echo $id_evento ?></y> </h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
           ...
           <h5>       Deseja realmente excluir o evento N°  <font color ="#9e0000">   <?php echo $id_evento ?></font> </h5>
            <br>
                  <input type="hidden" value="<?php echo $id_evento ?>" name="id_evento_excluir">
        </div>
        <div class="modal-footer">
