				...
				<div class="card">
					...
					<a href="adm.php?acao=diversos_adm&eventos=1"  style="color: black"> 
						<div class="card-body">
							...
							<p class="card-text">Administre e cadastre quando irão acontecer os atendimentos, palestras e comemorações</p>
					...
					<div class="card">
						...
						<a href="adm.php?acao=diversos_adm&posto_atend=1" onclick="alterna_cadastrar_ponto_atend_js()" style="color: black"> 
							<div class="card-body">
								...
								<p class="card-text">Administre e cadastre onde serão os pontos de atendimentos</p><br>
