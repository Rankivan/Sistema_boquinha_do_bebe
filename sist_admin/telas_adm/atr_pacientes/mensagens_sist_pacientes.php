    ...
    <form method="post" action="../../back_end/inserir_bd/pacientes/excluir_pacientes_anam.php">
     ...
     ="modal fade" id="msg_excluir_pacientes" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog ">
        <div class="modal-content">
          <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Excluir Paciente N° <?php echo $id_pac; ?></h5>
                
              </div>
              <div class="modal-body">

                <h5> Deseja realmente excluir o paciente N° <y style="color: #9e0000 "> <?php echo $id_pac; ?></y></h5>

                <input type="hidden" value="<?php echo $id_pac; ?>" name="id_excluir_pac">
