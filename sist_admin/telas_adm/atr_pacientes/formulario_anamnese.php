    ...
    <h5>Saúde:</h5><br>
               <div class="form-row">
                    <div class="form-group col-md-4">
                      ...
                      <input name="local_pre_natal_anam" type="text" class="form-control"  placeholder="Nome da cidade"required="">
                    </div>
                     ...
                     <!--__________________________-->
                      ...
                      <div class="form-group col-sm-3">
                          <label>Usou remédios na gestação</label>
                            <select name="uso_remedio_gest_anam"  class="form-control"  id="remedio_select_js" onchange="function_remedio_select_js()"required="">
                              <option value=""></option>
                      ...
                      <div id="medic_in" class="form-group col-md-5">
                            ...
                            <input name="uso_remedio_gest_anam_comp" type="text" class="form-control"  placeholder="Nome do(s) medicamento(s)">
          ...
          <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <label >Anomalia ao nascer</label>
                            <select name="anomalia_ao_nasc_anam"  class="form-control" onchange="function_anomalia_select_js()" id="anomalia_select_js" required="">
                              <option value=""></option>
                              <option value="sim">Sim</option>
                              <option value="nao">Não</option>
                             >
                   ...
                   <!--___________________________-->
                    <div class="form-group col-md-3">
                        ...
                        <label > Realiza Tratamento médico</label>
                            <select name="tratam_med_anam" class="form-control" id="tratamento_select_js" onchange="function_tratamento_select_js()" required="">
                              <option value=""></option>
                              <option value="sim">Sim</option>
                              <option value="nao">Não</option>
                             >
                  ...
                  <!--___________________________-->
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <div class="input-group flex-nowrap">
                        ...
                        <input name="pediatra_resp_anam" type="text" class="form-control" placeholder="Nome da pediatra rasponsável"required="">
                      </div>
                    </div>
                   ...
                   <!--___________________________-->
                    ...
                    <div class="form-group col-md-4">
                      <label >Dificuldade na amamentação</label>
                          <select name="dificuldade_alim_anam" class="form-control" id="amamentacao_select_js" onchange="function_amamentacao_select_js()"required="">
                            <option value=""></option>
                            <option value="sim">Sim</option>
                 ...
                 <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <label > Traumatismo bucal </label>
                        <select name="trauma_bucal_anam" class="form-control" id="trauma_select_js" onchange="function_trauma_select_js()" required="">
                            <option value=""></option>
                  ...
                  <textarea name="campo_observacoes_anam" placeholder="Insira observações inportantes sobre o paciente"  class="form-control"></textarea>
                </div>
         </div>